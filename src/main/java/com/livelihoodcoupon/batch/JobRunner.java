...
public class JobRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		log.info(
			"JobRunner 초기화 완료. CSV 배치는 /admin/batch/db/all-csv API를, 증분 추가 배치는 /admin/batch/db/new-csv API를 통해 수동 실행하세요.");
		log.info("또한 주차장 CSV 배치는 /admin/batch/db/parking-csv-to-db API를 통해 수동 실행하세요.");
