 ...
 * <h3>제공 엔드포인트:</h3>
 * <ul>
 *   <li><code>GET /admin/routes/monitoring/stats</code> - API 호출 통계</li>
 *   <li><code>GET /admin/routes/monitoring/health</code> - 제공자 헬스체크</li>
 *   <li><code>GET /admin/routes/monitoring/performance</code> - 성능 메트릭</li>
 * </ul>
 */
@Slf4j
@RestController
@RequestMapping("/admin/routes/monitoring")
