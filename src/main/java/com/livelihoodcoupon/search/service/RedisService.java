...
public class RedisService {
	...
	private final String PREFIX_SEARCH_ADDRESS = "search_address:";
	private final String PREFIX_SEARCH_CATEGORY = "search_category:";
	...
	/**
	 * ## 주소 저장
	 * HSET word:서울 field address subfield 시 parent ""
	 * HSET word:종로구 field address subfield 구 parent 서울
	 * HSET word:강남구 field address subfield 구 parent 서울
	 * HSET word:대구 field address subfield 시 parent ""
	 * HSET word:중구 field address subfield 구 parent 대구
	 * HSET word:동구 field address subfield 구 parent 대구
	 * HSET word:동성로 field address subfield 동 parent 중구
	 *
	 * 주소단어 저장
	...
	public void saveCategoryWord(String word, String field, String subfield, String parent) {
		String key = PREFIX_SEARCH_ADDRESS + word;
		hashOps.put(key, "field", field);
		hashOps.put(key, "subfield", subfield);
		hashOps.put(key, "parent", parent == null ? "" : parent);
	}
	...
	public String getWordInfo(String word) {
		String key = PREFIX_SEARCH_CATEGORY + word;
