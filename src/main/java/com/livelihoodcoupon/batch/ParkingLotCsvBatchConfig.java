...
public class ParkingLotCsvBatchConfig {
    ...
    private static final String[] COLUMN_NAMES = new String[] {
        ...
        "소재지지번주소", "주차구획수", "급지구분", "부제시행구분", "운영요일",
        "평일운영시작시각", "평일운영종료시각", "토요일운영시작시각", "토요일운영종료시각",
        "공휴일운영시작시각", "공휴일운영종료시각", "요금정보", "주차기본시간", "주차기본요금",
        "추가단위시간", "추가단위요금", "1일주차권요금적용시간", "1일주차권요금", "월정기권요금",
        "결제방법", "특기사항", "관리기관명", "전화번호", "위도", "경도",
        "장애인전용주차구역보유여부", "데이터기준일자", "제공기관코드", "제공기관명"
    };
